...
// Custom modules
use crate::client_video::{RawFrame, ResultBBOX};
    ...
    for raw_result in raw_results {
        ...
        let embedding = match precision {
            ...
            InferencePrecision::FP32 => {
                ...
                let data =
                    unsafe { Vec::from_raw_parts(raw_ptr as *mut f32, num_elements, num_elements) };
...
pub async fn process_frame(
    ...
    // Post process
    let measure_start = Instant::now();
    let embeddings = tokio::task::spawn_blocking(move || postprocess(raw_results, precision))
        .await
...
pub async fn process_bboxes(
    ...
    let pre_bboxes: Vec<Vec<u8>> = pre_bboxes_results
        .into_iter()
